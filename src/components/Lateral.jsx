...
export function Lateral({socket,id,password}) {
    ...
    return (
        <div className="lateral d-flex flex-row text-white p-3">
            <div className="d-flex flex-column gap-3">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-box-arrow-left" viewBox="0 0 16 16" onClick={() => exit()}>
